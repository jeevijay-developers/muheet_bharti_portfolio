        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-body text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed">
              Discover the collaborative journey with music industry
              legends—from Grammy-nominated productions to chart-topping
              compositions that bridge classical heritage with contemporary
              innovation.
            </p>
