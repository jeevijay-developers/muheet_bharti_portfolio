...
const IndustryNetwork = () => {
  ...
  const networkConnections = {
    arijit: {
      ...
      quote: "Muheet brings an extraordinary depth to every collaboration. His classical foundation elevates contemporary music.",
      collaborations: [
    ...
    shankar: {
      ...
      projects: 8,
      years: "2019-2024",
      achievements: ["Grammy Nominated", "Padma Shri", "Multiple National Awards"],
      quote: "Working with Muheet is like having access to centuries of musical wisdom in contemporary form.",
      collaborations: [
        "Heritage Echoes",
        "Fusion Experiments",
        "Cultural Bridge",
    ...
    salim: {
      ...
      projects: 6,
      years: "2021-2024",
      achievements: ["IIFA Winners", "Filmfare Awards", "International Recognition"],
      quote: "Muheet\'s sitar work transforms our compositions into something truly magical and authentic.",
      collaborations: [
        "Urban Ragas",
        "Film Score Mastery",
        "Electronic Fusion",
    ...
    rahman: {
      ...
      quote: "Muheet represents the future of Indian classical music in the global context.",
      collaborations: [
        "Timeless Melodies",
        "World Music Project",
        "Cultural Symphony",
    ...
    vishal: {
      ...
      projects: 5,
      years: "2020-2023",
      achievements: ["Multiple Filmfare Awards", "Chart Toppers", "Youth Icons"],
      quote: "Muheet\'s traditional expertise gives our modern compositions an authentic soul.",
      collaborations: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-primary/10 border border-primary/20 rounded-full mb-6">
              ...
              <span className="text-primary font-medium text-sm">INDUSTRY NETWORK</span>
            </div>
            ...
            <p className="text-body text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore the deep professional relationships and creative partnerships that define Muheet's journey in the music industry.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            {industryStats?.map((stat, index) => (
              <div key={index} className="bg-card rounded-xl shadow-contemplative border border-border p-6 text-center musical-hover">
            ...
            <div className="lg:col-span-2">
              <div className="bg-card rounded-xl shadow-grandeur border border-border p-8">
                <h3 className="text-headline text-xl font-bold text-foreground mb-6 flex items-center">
                  <Icon name="GitBranch" size={20} className="text-primary mr-3" />
                  Collaboration Network
                </h3>

                {/* Connection Selector */}
                <div className="flex flex-wrap gap-3 mb-8">
                  {Object.entries(networkConnections)?.map(([key, connection]) => (
                    <button
                      key={key}
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          <div className="text-sm text-muted-foreground mb-1">Connection Strength</div>
                          <div className="flex items-center">
                            <div className="w-20 bg-surface rounded-full h-2 mr-2">
                              <div
                                className="h-2 bg-primary rounded-full"
                                style={{ width: `${networkConnections?.[selectedConnection]?.connectionStrength}%` }}
                              ></div>
                            </div>
                            <span className="text-sm font-semibold text-primary">
                              {networkConnections?.[selectedConnection]?.connectionStrength}%
                            </span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-3 gap-4 mb-4">
                        <div>
                          ...
                          <div className="text-sm font-medium text-foreground">
                            {networkConnections?.[selectedConnection]?.relationship}
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground mb-1">Projects</div>
                          <div className="text-sm font-medium text-foreground">
                            {networkConnections?.[selectedConnection]?.projects} Collaborations
                          </div>
                        </div>
                        <div>
                          <div className="text-xs text-muted-foreground mb-1">Active Years</div>
                          <div className="text-sm font-medium text-foreground">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {networkConnections?.[selectedConnection]?.achievements?.map((achievement, index) => (
                            <span
                              key={index}
                      ...
                      <div>
                        <h5 className="text-sm font-semibold text-foreground mb-2">Notable Collaborations</h5>
                        <div className="grid grid-cols-2 gap-2">
                          {networkConnections?.[selectedConnection]?.collaborations?.map((collab, index) => (
            ...
            <div className="space-y-8">
                  ...
                  {connectionTypes?.map((type, index) => (
                    <div key={index} className="space-y-2">
                      <div className="flex items-center justify-between text-sm">
                        <span className="text-foreground font-medium">{type?.type}</span>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-accent/10 rounded-xl border border-primary/20 p-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed mb-4">
                    Trusted by music industry legends for authentic classical expertise and innovative fusion approaches.
                  </p>
              ...
              <div className="bg-card rounded-xl shadow-grandeur border border-border p-6">
                <h3 className="text-headline text-lg font-bold text-foreground mb-4 flex items-center">
                  <Icon name="Calendar" size={18} className="text-secondary mr-2" />
                  Upcoming Projects
                </h3>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-surface/50 rounded-lg">
                    <div>
                      <div className="text-sm font-medium text-foreground">New Album</div>
                      <div className="text-xs text-muted-foreground">with Arijit Singh</div>
                    </div>
                    <div className="text-xs text-primary font-medium">Q2 2025</div>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-surface/50 rounded-lg">
                    <div>
                      <div className="text-sm font-medium text-foreground">Film Score</div>
                      <div className="text-xs text-muted-foreground">International Project</div>
                    </div>
                    <div className="text-xs text-accent font-medium">Q3 2025</div>
                  </div>
                  
                  <div className="flex items-center justify-between p-3 bg-surface/50 rounded-lg">
                    <div>
                      <div className="text-sm font-medium text-foreground">Live Concert</div>
                      <div className="text-xs text-muted-foreground">Global Tour</div>
                    </div>
                    <div className="text-xs text-secondary font-medium">Q4 2025</div>
                  </div>
                </div>
              </div>
            </div>
